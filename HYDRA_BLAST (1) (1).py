...
class S(StatesGroup):
    ...
    bulk_add_credits_amount = State()
    bulk_deduct_credits_amount = State()
...
def owner_panel_text(d: dict) -> str:
    ...
    return (
        f"👑 <b>HYDRA VIP</b> — SMS Blast Bot {_VERSION}\n\n"
        f"━━━━━━━━━━━━━━━━━━\n"
        f"🔥 Firebase DBs  : <b>{len(fbs)}</b>\n"
...
def user_home_text(uid: int, d: dict) -> str:
    ...
    scan_info = get_scan_status()
    return (
        f"📱 <b>@HYDRA_GOKU VIP Blast Bot {_VERSION}</b>\n\n"
